...
while status_search:
	...
	if len(verify_search_product) > 0 and not pd.isnull(title_product[0]):
		...
		headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36', 'referer': f'https://google{region}',}
